...
import BestCoastImage from "@/assets/2025Pages/bestcoast.png";
...
export const About = () => {
  return (
    <>
      ...
      {/* BEST COAST Section */}
      <section id="bestcoast" className="bg-[#e6f2ff] py-20">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-12">
            <div className="lg:w-1/2 flex flex-col gap-8">
              <img
                src={BestCoastImage.src}
                alt="BEST COAST Event"
                className="rounded-lg shadow-xl max-w-full h-auto"
              />
            </div>
            ...
            <div className="lg:w-1/2 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  <a
                    href="https://liveai-bestcoast-2025.devpost.com/rules"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 hover:underline font-bold"
                  >
                  ...
                  and{" "}
                  <a
                    href="https://liveai-bestcoast-2025.devpost.com#prizes"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 hover:underline font-bold"
                  >
                ...
                <p className="text-lg text-gray-700">
                  To join <strong>LIVE AI Best Coast 2025</strong>, submit your resume and apply
                  here!
                </p>
                ...
                >
                  <button className="px-6 py-3 text-2xl font-bold text-white bg-[#2774AE] border border-[#1e5a8a] rounded-lg shadow-md hover:bg-[#1e5a8a] hover:shadow-lg transition-all duration-300">
                    Submit Application
                  </button>
                </a>
              </div>

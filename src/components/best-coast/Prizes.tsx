                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-8 space-y-6">
                        ...
                        <div className="prose prose-lg max-w-none">
                            <p className="text-gray-700 leading-relaxed">
                                LIVE AI Best Coast 2025 is set to offer $10,000 in prizes across a variety of categories, with each prize being awarded in three prize pools: onsite at UCLA, onsite at Stanford University, and online. Participants can compete in numerous fields including Artificial Intelligence, Blockchain/Web3, and Financial Technology.
                            </p>
